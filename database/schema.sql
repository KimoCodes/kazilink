...
CREATE TABLE admin_audit (
    ...
    target_type ENUM('user', 'task', 'dispute', 'plan', 'promo_code', 'subscription', 'momo_transaction', 'setting', 'momo_webhook_log', 'subscription_payment_intent') NOT NULL,
...
CREATE TABLE subscription_payment_intent_audit (
    id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
