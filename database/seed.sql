...
('batsindakeynesbenoit10101@gmail.com', '$2y$10$o/nxyOqxV4gSDRs8R3xSh.7BMY1ajFeKbhwKrsTHIXm2L3S5st/s2', 'admin', 1, 0, NULL, NULL, NULL, NULL, NOW(), NOW()),
...
((SELECT id FROM users WHERE email = 'batsindakeynesbenoit10101@gmail.com'), 'Admin User', NULL, 'Kigali', NULL, 'Rwanda', 'Marketplace administrator.', NULL, NULL, NOW(), NOW()),
