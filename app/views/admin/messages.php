        ...
        <div class="summary-grid booking-index-summary">
            <article class="info-card task-summary-card">
                ...
                <div class="task-summary-metric-row">
                    ...
                    <span><?= $showFilter === 'unreplied' ? 'Messages still waiting on a first admin reply' : 'Messages captured from the public contact form with delivery tracking' ?></span>
                </div>
            </article>
            <article class="info-card task-summary-card">
                ...
                <div class="task-summary-metric-row">
                    ...
                    <span>Replies are recorded locally and queued through the centralized email delivery worker</span>
                </div>
            </article>
        </div>
                ...
                <?php foreach ($messages as $message): ?>
                    ...
                    <article class="panel panel-subtle">
                        ...
                        <form method="post" action="<?= e(url_for('admin/reply-message')) ?>" class="form-grid" novalidate>
                            ...
                            $required = true;
                            $hint = 'The reply is recorded locally and queued for background email delivery through the centralized email service.';
                            $error = null;
