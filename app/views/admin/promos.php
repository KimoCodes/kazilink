            ...
            <article class="feature-card">
                ...
                <div class="table-wrap">
                    <table class="data-table">
                        <thead>
                            <tr><th>Code</th><th>Discount</th><th class="hide-mobile">Targets</th><th class="hide-mobile">Redeemed</th><th>Expires</th><th>Status</th><th></th></tr>
                        </thead>
                        <tbody>
                            <?php foreach ($promos as $promo): ?>
                                <tr>
                                    ...
                                    <td class="hide-mobile"><?= e((string) $promo['targeted_user_count']) ?></td>
                                    <td class="hide-mobile"><?= e((string) $promo['redemption_count']) ?></td>
