...
<div class="container">
    <section class="panel">
        ...
        $eyebrow = 'Admin';
        $intro = 'Edit your email campaign details and content.';
        ...
        <form method="post" action="<?= e(url_for('admin/newsletter-campaigns/edit', ['id' => $campaign['id']])) ?>" class="theme-form">
            <?= Csrf::input() ?>
            ...
            <div class="theme-admin-panel">
                <div class="theme-card">
                    ...
                    <div class="theme-field">
                        <small class="field-info">
                            <strong>Campaign Status:</strong> <span class="pill pill-info"><?= e(ucfirst($campaign['status'])) ?></span>
                            <br>
                            <strong>Created:</strong> <?= e(dateFmt($campaign['created_at'])) ?>
                            <?php if ($campaign['scheduled_at']): ?>
                                <br>
                                <strong>Scheduled:</strong> <?= e(dateFmt($campaign['scheduled_at'])) ?>
                            <?php endif; ?>
                        </small>
                    </div>
                </div>
                ...
                <div class="theme-card">
                    <div class="theme-card-head">
                        <h3>Email Content</h3>
                        <p>Edit your email content using HTML formatting.</p>
                    </div>
            ...
            <div class="theme-form-actions">
                ...
                <a href="<?= e(url_for('admin/newsletter-campaigns/show', ['id' => $campaign['id']])) ?>" class="button button-secondary">View Campaign</a>
