            ...
            <article class="feature-card">
                ...
                <div class="table-wrap">
                    <table class="data-table">
                        <thead>
                            <tr><th>Name</th><th class="hide-mobile">Slug</th><th>Price</th><th class="hide-mobile">Priority</th><th class="hide-mobile">Applications</th><th class="hide-mobile">Jobs</th><th>Badge</th><th>Status</th><th>Subscribers</th><th></th></tr>
                        </thead>
                        <tbody>
                            <?php foreach ($plans as $plan): ?>
                                <tr>
                                    <td><strong><?= e((string) $plan['name']) ?></strong></td>
                                    <td class="hide-mobile"><span class="text-mono"><?= e((string) $plan['slug']) ?></span></td>
                                    <td><?= e(moneyRwf((int) $plan['price_rwf'])) ?></td>
                                    <td class="hide-mobile"><?= e((string) $plan['priority_level']) ?></td>
                                    <td class="hide-mobile"><?= e((string) $plan['max_applications_per_day']) ?>/day</td>
                                    <td class="hide-mobile"><?= e((string) $plan['max_active_jobs']) ?></td>
