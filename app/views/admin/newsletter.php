...
<div class="container">
    <section class="panel">
        ...
        $eyebrow = 'Admin';
        $intro = 'Review captured newsletter signups, segment them by audience, and track operational email delivery from one admin workspace.';
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th class="hide-mobile">Consent</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($subscriptions as $subscription): ?>
                            ...
                            <tr>
                                ...
                                <td class="hide-mobile"><?= e((string) ($payload['source_route'] ?? $subscription['route'] ?? 'home/index')) ?></td>
                                <td class="hide-mobile cell-wrap"><?= e((string) ($payload['consent_text'] ?? 'Subscriber asked to receive updates.')) ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
