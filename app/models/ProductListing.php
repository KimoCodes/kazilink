    ...
    public function browseOpen(array $filters, int $limit = 25, int $offset = 0): array
    {
        $sql = '
            SELECT
                ...
                COALESCE(plan_visibility.plan_name, "Basic") AS seller_plan_name,
            ...
            ) AS plan_visibility ON plan_visibility.user_id = l.seller_id
        ...
        $sql .= '
            GROUP BY l.id, seller.email, p.full_name, seller_visibility_level, seller_plan_name
        ';
