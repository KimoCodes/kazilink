...
$title = (string) ($data['subject'] ?? 'Payment submitted successfully');
...
<body style="margin:0;padding:0;background:#f6f1e7;font-family:Arial,sans-serif;color:#1f1a17;">
  <div style="max-width:640px;margin:0 auto;padding:24px;">
    <div style="background:#ffffff;border:1px solid #e6dccd;border-radius:16px;padding:32px;">
      ...
      <p style="margin:0 0 20px;font-size:16px;line-height:1.6;">We received your payment proof and it is now pending verification.</p>
      ...
      <?php if ($paymentLink !== ''): ?>
        <p style="margin:0 0 24px;"><a href="<?= e($paymentLink); ?>" style="display:inline-block;background:#1f1a17;color:#ffffff;text-decoration:none;padding:12px 20px;border-radius:999px;font-weight:700;">Track Payment</a></p>
      <?php endif; ?>
