...
$title = (string) ($data['subject'] ?? 'Payment approved');
...
<body style="margin:0;padding:0;background:#f6f1e7;font-family:Arial,sans-serif;color:#1f1a17;">
  <div style="max-width:640px;margin:0 auto;padding:24px;">
    <div style="background:#ffffff;border:1px solid #e6dccd;border-radius:16px;padding:32px;">
      ...
      <p style="margin:0 0 20px;font-size:16px;line-height:1.6;">Your payment has been verified successfully.</p>
      <table style="width:100%;border-collapse:collapse;margin:0 0 24px;">
        ...
        <tr><td style="padding:8px 0;font-weight:700;">Approved</td><td style="padding:8px 0;"><?= e($reviewedAt); ?></td></tr>
        <tr><td style="padding:8px 0;font-weight:700;">Activation</td><td style="padding:8px 0;"><?= e($activation); ?></td></tr>
      </table>
      <?php if ($paymentLink !== ''): ?>
        <p style="margin:0 0 24px;"><a href="<?= e($paymentLink); ?>" style="display:inline-block;background:#1f1a17;color:#ffffff;text-decoration:none;padding:12px 20px;border-radius:999px;font-weight:700;">View Payment</a></p>
      <?php endif; ?>
      <p style="margin:0;font-size:14px;line-height:1.6;color:#5c5146;">Questions? Contact <?= e($data['support_email']); ?><?php if ((string) $data['support_phone'] !== ''): ?> or call <?= e($data['support_phone']); ?><?php endif; ?>.</p>
    </div>
  </div>
</body>
</html>
